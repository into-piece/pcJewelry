export const fppurchase = [
  ...
  { key: '客户订单', value: 'orderNo' , 'type': 7, 'list': 'listPInotdone',wrapperColSpan:24,labelColSpan:24},
  ...
  { key: '供货商编号', value: 'supplierCode', 'type': 7, 'list': 'supplierlistDropDown',wrapperColSpan:24,labelColSpan:24},
  { key: '供货商简称', value: 'supplierShotName' ,disabled:true,wrapperColSpan:24,labelColSpan:24},
  ...
  { key: '付款类别', value: 'typeOfPayment',  'type': 7, 'list': 'listH019',wrapperColSpan:24,labelColSpan:24},
  ...
  { key: '税率', value: 'taxRate' ,  'number': true,dfv:0.0,'step':0.1,'min':0,precision:1,wrapperColSpan:24,labelColSpan:24},
