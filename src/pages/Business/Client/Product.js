...
class Product extends PureComponent {
  ...
  render() {
    ...
    return (<div className={styles.content}>
      ...
      <DescriptionList size='small' col='2'>
        <Description size="small" term='产品序列编号'></Description>
  ...
  getContantItem = (item) => {
    ...
    return (
      <div>
        <DescriptionList size='small' col='2'>
          <Description size="small" term='产品序列编号'>{item.productNo}</Description>
          <Description size="small" term='产品系列名称'>{item.productNo}</Description>
          <Description size="small" term='产品报价系数'>{item.productNo}%</Description>
        </DescriptionList>
        <List
          loading={false}
          dataSource={listdata}
