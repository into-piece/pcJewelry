...
const firstTabFlag = 'processSalary';

@Form.create()
@connect(({ loading, processSalary: model }) => {
  return {
    model,
...
class Index extends Component {
  ...
  // 获取Modal的标题
  returnTitle = () => {
    const menuText = <FormattedMessage id="menu.erp.finance.processSalary" defaultMessage="processSalary" />;
    return menuText;
  };
