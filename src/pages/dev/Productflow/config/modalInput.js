export const productFlow = [
  ...
  { 'key': '终客编号', 'value': 'endId', 'type': 2, 'list': 'endCustomerList', 'noNeed': true },
  { 'key': '终客简称', 'value': 'endShotName', 'noNeed': true },
  {
    'key': '报价方式',
    'value': 'quoteMethod',
    'type': 6,
  ...
  { 'key': '字印英文名', 'value': 'markingEnName', 'type': 7, 'noNeed': true },
  {
    ...
    'value': 'packPriceType',
    'type': 6,
    'arr': [{ 'key': '计收', 'value': 'H011001' }, { 'key': '不计收', 'value': 'H011002' }],
    'initValue': 'H011002',
  },
  {
    'key': '客户备料',
  ...
  {
    'key': '向客户采购用料',
    'value': 'purchasingMaterialsFromCustomers',
    'text': '向客户采购',
    'type': 5,
    'noNeed': true,
    'initValue': 0,
