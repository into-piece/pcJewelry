...
class SpecimenDetaill extends Component {
        ...
        >
            ...
            <Col lg={4} md={4} sm={4} xs={4}>
              ...
              >
                {getFieldDecorator('productNo', {
                  ...
                  // })(<text>系统自动生成</text>)}
                })(<Input placeholder="自动生成流水号" readOnly={true} />)}
              </FormItem>
            </Col>
            <Col lg={4} md={4} sm={4} xs={4}>
              <FormItem
                ...
                {getFieldDecorator('mouldNo', {
                  ...
                  <MoldListSelect
                    ...
                    onSelect={v => {
                      ...
                      if (v && v.mainMold) this.state.cNomainMold = v.mainMold;
                      this.parseProductNo();
                    }}
                  />
                )}
            ...
            <Col lg={5} md={5} sm={5} xs={5}>
              ...
              >
                {getFieldDecorator('unitOfWeight', {
                  ...
                  <BasicMeasureListSelect
                    content={
                      current.unitOfWeight
                        ? current.unitOfWeight
                        : '8ee1cc72791578cfe122f6839487bbbe'
                    }
                    placeholder="请输入"
                  />
                )}
          ...
          <Row>
            <Col lg={24} md={24} sm={24} xs={24}>
              <FormItem label="" {...this.centerFormLayout} className={business.from_content_col}>
                <Upload
                  accept="image/*"
                  name="avatar"
                  beforeUpload={() => {
                  ...
                  <TerminalListSelected
                    ...
                    onSelectEndName={(file, customerCombine) => {
                      if (file && customerCombine) {
                        ...
                        (this.state.cNoCustomerCombine = customerCombine), this.parseProductNo();
                      }
                    }}
                  />
                )}
  ...
  parseProductNo = () => {
    ...
    const productNo =
      cNoBrandNo + cNofCode + '-' + showMold + cNoUnitCode + cNoColorCode + cNoCustomerCombine;
