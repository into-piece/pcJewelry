      ...
      >
        <div>
          <DescriptionList size="small" col="2">
            ...
            <Description term="字印价" className={clientStyle.small_description}>
              {item.markingPrice}
            </Description>
          </DescriptionList>
          <DescriptionList size="small" col="1">
            <Description term="字印英文名" className={clientStyle.small_description}>
              {item.enName}
            </Description>
            <Description term="字印中文名" className={clientStyle.small_description}>
              {item.zhName}
            </Description>
            <Description term="字印说明" className={clientStyle.small_description}>
              {item.markingExplain}
            </Description>
          </DescriptionList>
        </div>
