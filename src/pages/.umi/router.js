            ...
            routes: [
              {
                ...
                component: __IS_BROWSER
                  ? _dvaDynamic({
                      app: require('@tmp/dva').getApp(),
                      models: () => [
                        import(/* webpackChunkName: 'p__system__Department__models__model.js' */ '/Users/chensongbin/Documents/GitHub/jewelry/src/pages/system/Department/models/model.js').then(
                          m => {
                            return { namespace: 'model', ...m.default };
                          },
                        ),
